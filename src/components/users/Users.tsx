...
import { getUsersTC, ThunkUsersType, } from '../../redux/usersReducer';
...
const Users: React.FC = (props) => {
   ...
   useEffect(() => {
      ...
      const actualTerm = term.length ? term : filter.term;
      const actualFriend = friend.length ? friend === 'true' : filter.friend;
